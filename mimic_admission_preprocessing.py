...
def preprocess_admission(admission_notes_data_path:str, admission_table_path:str, verbose:bool = False) -> pd.DataFrame:
    ...
    admission_table_df = admission_table_df[['subject_id', 'hadm_id', 'icustay_id', 'age', 'gender', 'admission_location']]
    ...
    admission_table_df = admission_table_df[['hadm_id', 'icustay_id', 'age', 'Sex', 'Referral']]
    ...
    admission_table_df = pd.melt(admission_table_df, id_vars=['hadm_id', 'icustay_id'],
